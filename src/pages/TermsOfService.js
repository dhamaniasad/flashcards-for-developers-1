...
const TermsOfService = () => (
  <div className="container container--narrow py-5">
    ...
    <p>
      ...
      <a href="http://www.flashcardsforstudents.com">www.flashcardsforstudents.com</a>, you are
    ...
    <ol type="a">
      <li>
        ...
        software) on Flashcards for students' website for personal, non-commercial transitory
      ...
      <li>
        ...
        be terminated by Flashcards for students at any time. Upon terminating your viewing of
    ...
    <ol type="a">
      <li>
        The materials on Flashcards for students' website are provided on an 'as is' basis.
        Flashcards for students makes no warranties, expressed or implied, and hereby disclaims
      ...
      <li>
        Further, Flashcards for students does not warrant or make any representations concerning
    ...
    <h3>4. Limitations</h3>
    <p>
      In no event shall Flashcards for students or its suppliers be liable for any damages
      (including, without limitation, damages for loss of data or profit, or due to business
      interruption) arising out of the use or inability to use the materials on Flashcards for
      students' website, even if Flashcards for students or a Flashcards for students
    ...
    <p>
      The materials appearing on Flashcards for students' website could include technical,
      typographical, or photographic errors. Flashcards for students does not warrant that any of
      the materials on its website are accurate, complete or current. Flashcards for students may
      make changes to the materials contained on its website at any time without notice. However
      Flashcards for students does not make any commitment to update the materials.
    </p>
    <h3>6. Links</h3>
    <p>
      Flashcards for students has not reviewed all of the sites linked to its website and is not
      responsible for the contents of any such linked site. The inclusion of any link does not imply
      endorsement by Flashcards for students of the site. Use of any such linked website is at the
      user's own risk.
    </p>
    <h3>7. Modifications</h3>
    <p>
      Flashcards for students may revise these terms of service for its website at any time
